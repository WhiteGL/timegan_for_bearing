...
# 2. Data Loading
from data_loading import google_data_loading, sine_data_generation, bearing_data_loading
...
elif data_name == 'bearing':
    dataX = bearing_data_loading(seq_length)
